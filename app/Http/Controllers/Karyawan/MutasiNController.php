...
class MutasiNController extends Controller
{
    public function index()
    {
        ...
        return view('karyawan.mutasinkaryawan', compact('data'));
    }
    ...
    public function show($id)
    {
        ...
        return view('karyawan.mutasi.lihatm', compact('data'));
    }

    public function create()
    {
        return view('karyawan.mutasi.tambahm');
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('karyawan.mutasi')->with('success', 'Data berhasil ditambahkan');
    }
    ...
    public function edit(Request $request,$id)
    {
        ...
        if (!$data) {
            return redirect()->route('karyawan.mutasi')->withErrors('Data tidak ditemukan.');
        }

        return view('karyawan.mutasi.ubahm', compact('data'));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        // Redirect dengan pesan sukses
        return redirect()->route('karyawan.mutasi')->with('success', 'Data berhasil diperbarui');
    }
    ...
    public function destroy($id)
    {
        ...
        return redirect()->route('karyawan.mutasi')->with('success', 'Data berhasil dihapus.');
    }
    ...
    public function print($id)
    {
        ...
        if (!$mutasi) {
            return redirect()->route('karyawan.mutasi')->with('error', 'Data tidak ditemukan.');
        }
        ...
        $pdf = Pdf::loadView('karyawan.mutasi.surat', $data);
