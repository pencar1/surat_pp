  ...
  <section class="section">
    ...
    <div class="section-body">
      <div class="row justify-content-center">
        <div class="col-12">
          <div class="card">
            <form action="{{ route('admin.rubahtarif.update', ['id_pel' => $data->id_pel]) }}" 
              ...
              <div class="card-body">
                ...
                <div class="form-group">
                  ...
                  <select name="tarif_semula" id="tarif_semula" 
                          class="form-control @error('tarif_semula') is-invalid @enderror">
                    <option value="">-- Pilih Tarif/Daya Semula --</option>
                    @foreach (['R1/450 VA', 'R1T/450 VA', 'R1/900 VA', 'R1T/900 VA'] as $option)
                      <option value="{{ $option }}" 
                              {{ old('tarif_semula', $data->tarif_semula) == $option ? 'selected' : '' }}>
                        {{ $option }}
                      </option>
                    @endforeach
                  </select>
                ...
                <div class="form-group">
                  ...
                  <select name="tarif_menjadi" id="tarif_menjadi" 
                          class="form-control @error('tarif_menjadi') is-invalid @enderror">
                    <option value="">-- Pilih Tarif/Daya Menjadi --</option>
                    @foreach (['R1/450 VA', 'R1T/450 VA', 'R1/900 VA', 'R1T/900 VA'] as $option)
                      <option value="{{ $option }}" 
                              {{ old('tarif_menjadi', $data->tarif_menjadi) == $option ? 'selected' : '' }}>
                        {{ $option }}
                      </option>
                    @endforeach
                  </select>
...
@endforeach
              ...
              <div class="card-footer text-right">
                ...
                <button type="reset" class="btn btn-danger" 
                        onclick="window.location.href='{{ route('admin.rubahtarif') }}'">Batal</button>
              </div>
