  ...
  <section class="section">
    <div class="section-header">
      ...
      <div class="section-header-breadcrumb">
        ...
        <div class="breadcrumb-item"><a href="{{ route('karyawan.mutasi') }}">Mutasi N</a></div>
    ...
    <div class="section-body">
      <div class="row justify-content-center">
        <div class="col-12">
          <div class="card">
            <form action="{{ route('karyawan.mutasi.update', ['id' => $data->idpel]) }}" method="POST" class="needs-validation" enctype="multipart/form-data">
              @csrf
              @method('PUT')
              ...
              <div class="card-body">
                ...
                <div class="form-group">
                    ...
                    <div class="input-group">
                        ...
                        <input type="text" name="rptag3lembar" id="rptag3lembar" class="form-control @error('rptag3lembar') is-invalid @enderror" placeholder="Masukkan RP TAG 3 Lembar" value="{{ old('rptag3lembar', $data->rptag3lembar) }}" oninput="formatNumber3(this); calculateTotal3();">
                        @error('rptag3lembar')
                        <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                ...
                <div class="form-group">
                    ...
                    <div class="input-group">
                        <span class="input-group-text">Rp.</span>
                        <input type="text" name="rpbk3lembar" id="rpbk3lembar" class="form-control @error('rpbk3lembar') is-invalid @enderror" placeholder="Masukkan RP BK 3 Lembar" value="{{ old('rpbk3lembar', $data->rpbk3lembar) }}" oninput="formatNumber3(this); calculateTotal3();">
                        @error('rpbk3lembar')
                        <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                ...
                <div class="form-group">
                    ...
                    <div class="input-group">
                        <span class="input-group-text">Rp.</span>
                        <input type="text" name="rptag1lembar" id="rptag1lembar" class="form-control @error('rptag1lembar') is-invalid @enderror" placeholder="Masukkan RP TAG 1 Lembar" value="{{ old('rptag1lembar', $data->rptag1lembar) }}" oninput="formatNumber(this); calculateTotal();">
                        @error('rptag1lembar')
                        <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                ...
                <div class="form-group">
                    ...
                    <div class="input-group">
                        <span class="input-group-text">Rp.</span>
                        <input type="text" name="rpbk1lembar" id="rpbk1lembar" class="form-control @error('rpbk1lembar') is-invalid @enderror" placeholder="Masukkan RP BK 1 Lembar" value="{{ old('rpbk1lembar', $data->rpbk1lembar) }}" oninput="formatNumber(this); calculateTotal();">
                        @error('rpbk1lembar')
                        <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="titikkoordinat" id="titikkoordinat" class="form-control @error('titikkoordinat') is-invalid @enderror" placeholder="Masukkan Titik Koordinat" value="{{ old('titikkoordinat', $data->titikkoordinat) }}">
              ...
              <div class="card-footer text-right">
                ...
                <button type="reset" class="btn btn-danger" onclick="window.location.href='{{ route('karyawan.mutasi') }}'">Batal</button>
              </div>
            </form>
          </div>
        </div>
